<li class="ui-widget-content ui-corner-tr <?php if ($picture->getDescription()) echo "ui-state-hover" ?>" id="picture_<?php echo $picture->getId(); ?>">
  ...
  <a href="<?php echo $picture->getImageRoute("normal"); ?>" data-fancybox="gallery" data-caption="#<?php echo $picture->getPosition(); ?>" class="ui-icon ui-icon-zoomin"><?php echo __('View larger image', null, 'sf_gallery_manager') ?></a>
